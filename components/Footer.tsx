  ...
  return (
    <div className="bg-[#F5F9FA] py-8 md:py-16">
        ...
        <div>
          ...
          <ul className="bg-gray-50 p-4 rounded-lg text-sm">
            <li className="flex justify-between mb-2">
              <span>Mon - Fri:</span> <span className="font-semibold">7am - 6pm</span>
            </li>
            <li className="flex justify-between mb-2">
              <span>Saturday:</span> <span className="font-semibold">9am - 4pm</span>
            </li>
            <li className="flex justify-between">
              <span>Sunday:</span> <span className="text-red-500 font-semibold">Closed</span>
            </li>
          </ul>
        </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-600 pt-6">
        <p>
          © Copyrights <span className="text-primary">Polk County Bully Project</span> All rights reserved
        </p>
        <p>
          Design & Developed by <span className="text-primary">BayShore Communication</span>
        </p>
      </div>
    </footer>
    </div>
